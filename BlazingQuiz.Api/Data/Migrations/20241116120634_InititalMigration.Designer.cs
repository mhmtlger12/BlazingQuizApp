...
namespace BlazingQuiz.Api.Data.Migrations
{
    ...
    [Migration("20241116120634_InititalMigration")]
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.Property<string>("PassworsdHash")
                        .IsRequired()
                        .HasMaxLength(250)
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Mehmet Güler",
                            PassworsdHash = "AQAAAAIAAYagAAAAEIyyaVF+pmBA2AU++x+t7NMiOlnowFKPBfmzbktDeCEmuGeHTLle/l6kkS+c4LpPLQ==",
                            Phone = "5367017748",
                            Role = "Admin"
                        });
                });
